...
var question = ["France", "Islande", "Portugal", "Espagne",
    "Belgique", "Italie", "Bielo Russie", "Pologne", "Grece",
    "Finlande","Allemagne","Suede", "Norvege", "Ukraine",
    "Chypre", "Irlande", "Suisse", "Autriche", "Tchequie",
    "Slovaquie", "Hongrie", "Lituanie", "Lettonie",
    "Moldavie", "Roumanie", "Bulgarie", "Albanie",
    "Estonie", "Andore", "Saint Marin", "Monaco",
    "Luxembourg", "Lichenstein", "Pays Bas", "Boznie",
    "Slovenie", "Macedoine", "Croatie", "Danemark",
    "Russie", "Montenegro", "Serbie", "Royaume Unie",
    "Malte"];
var totalScore = '';
...
function gameFinished() {
    ...
    totalScore = ((score*(1+(timerValue/10)))/25)*10
    if (trainingMod == false) {
        if (totalScore<=15) {
...
function answerParameter(numberOfErrorP, indexIncreaseP, scoreP, question, bumpP) {
...
function winChecking(answer,question) {
        if (answer==question[indexIncrease]) {
            ...
            answerParameter( 0, 1, 10, question, true );
            numberOfError = 0;
        }
        }
        else {
            ...
            if (numberOfError==2) {
                ...
                answerParameter(0, 1, 0, question, true);
                numberOfError = 0;
            }
            }
            else {
                answerParameter(1, 0, 0, question, false);
            }
        }
    }
